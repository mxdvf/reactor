...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    actorAdded: async (
      remoteActorInfo: RemoteActorInfo,
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.actorAdded(
        remoteActorInfo,
        options,
      );
    ...
    async registerLib(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.registerLib(
        registrationArgs,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
    ...
    async startActor(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string,
      ) => AxiosPromise<RemoteActorInfo>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.startActor(
        spawnArgs,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    actorAdded(
      ...
      return localVarFp
        .actorAdded(remoteActorInfo, options)
    ...
    registerLib(
      ...
      return localVarFp
        .registerLib(registrationArgs, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
